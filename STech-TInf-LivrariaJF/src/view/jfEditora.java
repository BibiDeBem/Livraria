...
public class jfEditora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jtEditora.getColumnModel().getColumnCount() > 0) {
            jtEditora.getColumnModel().getColumn(0).setMinWidth(40);
            jtEditora.getColumnModel().getColumn(0).setPreferredWidth(40);
            jtEditora.getColumnModel().getColumn(0).setMaxWidth(40);
        }
    ...
    private void jbDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDeletarActionPerformed
        ...
        String gerente;
        linha = jtEditora.getSelectedRow();
        gerente = (String) jtEditora.getValueAt(linha, 1);
        //Pessoa p = cadPessoas.getByDoc(cpf);
        EditoraServicos editoraS = ServicosFactory.getEditoraServicos();
